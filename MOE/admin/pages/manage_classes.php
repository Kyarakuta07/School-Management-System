...
<body class="open">
    <div class="container">
        ...
        <main class="main">
            <header class="main-header">
                <h1 class="main-h1">Manage Classes</h1>
                <h2 class="main-h2">Kelola data nilai dan jadwal kelas di Odyssey Sanctuary</h2>
            </header>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="edit_schedule.php?id=<?php echo $schedule['id_schedule']; ?>" class="btn-edit">
                                                <i class="uil uil-edit"></i>
                                            </a>
                                            <a href="delete_schedule.php?id=<?php echo $schedule['id_schedule']; ?>" class="btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus jadwal ini?');">
    ...
    <script>
        ...
        const fetchGrades = (searchTerm) => {
            ...
            xhr.onload = function() {
                if (this.status == 200) {
                    document.getElementById('gradesTableBody').innerHTML = this.responseText;
                }
            }
        ...
        gradeSearchInput.addEventListener('keyup', function() {
