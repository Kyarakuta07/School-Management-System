...
<body>
    ...
    <main class="main-content">
        ...
        <div class="dashboard-grid">
            ...
            <div class="card card-stat card-stat--online">
                <div class="stat-title">System Status</div>
                <div class="stat-value stat-value--status">ONLINE</div>
                ...
                <div class="user-list">
                    ...
                    if (mysqli_num_rows($result_latest_users) > 0) {
                        ...
                        while ($user = mysqli_fetch_assoc($result_latest_users)):
                            ?>
                            <div class="user-item">
                                <span class="user-name user-name--truncate">
