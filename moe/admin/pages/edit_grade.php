...
$id_grade_to_edit = (int)$_GET['id']; // Pastikan integer
                ...
                <div style="max-width: 600px; margin: 0 auto;">
                    <form action="proses_update_grade.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_anggota" value="<?php echo htmlspecialchars($grade_data['nama_lengkap']); ?>" disabled>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="english" name="english" value="<?php echo htmlspecialchars($grade_data['english']); ?>" min="0" max="100" required>
                            </div>

                            <div class="form-group">
                                <label for="herbology">Nilai Herbology</label>
                                <input type="number" id="herbology" name="herbology" value="<?php echo htmlspecialchars($grade_data['herbology']); ?>" min="0" max="100" required>
                            </div>

                            <div class="form-group">
                                <label for="oceanology">Nilai Oceanology</label>
                                <input type="number" id="oceanology" name="oceanology" value="<?php echo htmlspecialchars($grade_data['oceanology']); ?>" min="0" max="100" required>
                            </div>

                            <div class="form-group">
                                <label for="astronomy">Nilai Astronomy</label>
                                <input type="number" id="astronomy" name="astronomy" value="<?php echo htmlspecialchars($grade_data['astronomy']); ?>" min="0" max="100" required>
                            </div>
