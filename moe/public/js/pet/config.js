 ...
 * @constant {string}
 */
export const API_BASE = (typeof window.API_BASE !== 'undefined') ? window.API_BASE : (() => { console.warn('API_BASE not set by layout, using fallback /api/'); return '/api/'; })();

/**
 * Base path for pet asset images
 * @constant {string}
 */
export const ASSETS_BASE = (typeof window.ASSET_BASE !== 'undefined') ? window.ASSET_BASE + 'assets/pets/' : '../assets/pets/';
