 ...
 * 
 * REFACTORED VERSION - Uses new bootstrap system
 */
...
<body>
    ...
    <div class="main-dashboard-wrapper">
        ...
        <nav class="top-nav-menu">
            ...
            <a href="sanctuary.php" class="nav-btn"><i class="fa-solid fa-users"></i><span>Sanctuary</span></a>
                    ...
                    <div class="card-content">
                        ...
                        <p>Anda adalah anggota dari <?= e($sanctuary_name) ?> Sanctuary.
                            ...
                            <?php if (!empty($sanctuary_desc)): ?>
                                <?= e($sanctuary_desc) ?>
                            <?php else: ?>
                                Sanctuary <?= e($sanctuary_name) ?> adalah salah satu dari lima sanctuary suci
                                di Mediterranean of Egypt. Setiap sanctuary memiliki karakteristik dan sejarah
                                yang unik, membentuk identitas para Nethera yang tergabung di dalamnya.
                            <?php endif; ?>
                        </p>
                    </div>
                </div>
