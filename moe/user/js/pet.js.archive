...
// ================================================
// COLLECTION RENDERING - HANDLED BY pet_hardcore_update.js
// The renderCollectionWithButtons function in pet_hardcore_update.js
// overrides this and handles all collection card rendering with:
// - Info button for pet details
// - Sell/Evolve buttons
// - Element badges
// ================================================

// ================================================
// PET DETAIL MODAL - MOVED TO js/pet/detail-modal.js
// Functions: setActivePet, openPetDetailById, selectPet, 
//            openPetDetail, closePetDetail, setActiveFromDetail
// ================================================
...
// ================================================
// Note: setActivePet, openPetDetailById, closePetDetail,
//       selectPet, openPetDetail, setActiveFromDetail
//       are now exported from js/pet/detail-modal.js
