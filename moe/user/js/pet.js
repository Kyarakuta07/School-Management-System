...
function switchTab(tab) {
    ...
    switch (tab) {
        case 'my-pet':
            ...
            if (window.activePet) {
                renderwindow.activePet();
            } else {
                loadwindow.activePet(); // Fallback if no active pet loaded yet
            }
            break;
        case 'collection':
            loadPets();
        ...
        case 'shop':
            ...
            break;
        case 'arena':
            loadwindow.activePet(); // Refresh HP after battles
            loadOpponents();
            break;
        case 'arena3v3':
...
async function loadwindow.activePet() {
    try {
...
function renderwindow.activePet() {
    // New elements
