    ...
    `).join('');
        ...
        `;
            ...
            function updateCollectionStats() {
                ...
                document.getElementById('stat-rarities').textContent = `${stats.common}/${stats.rare}/${stats.epic}/${stats.legendary}`;
                document.getElementById('stat-shiny').textContent = stats.shiny;
            }
