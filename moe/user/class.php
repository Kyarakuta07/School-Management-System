...
<body>
    ...
    <style>
        ...
        #selected-student-name { font-weight: 600; color: #fff; }
        .sanctuary-tag {
            padding: 4px 10px;
        ...
        .grade-input:focus { border-color: var(--subject-color); outline: none; }
        .total-preview {
            display: flex;
            justify-content: space-between;
            align-items: center;
        ...
        .btn-hakaes:hover { transform: translateY(-2px); box-shadow: 0 4px 15px rgba(76,175,80,0.4); }
        .grade-result {
            padding: 12px;
            border-radius: 8px;
            margin-top: 12px;
        ...
        .grade-result.success { background: rgba(76, 175, 80, 0.2); color: #4caf50; }
        .grade-result.error { background: rgba(231, 76, 60, 0.2); color: #e74c3c; }
        
        @media (max-width: 480px) {
            .grade-inputs { grid-template-columns: 1fr; }
        }
    </style>
