...
class Auth extends ShieldAuth
{
    ...
    public array $redirects = [
        ...
        'logout'            => 'login',
        'force_reset'       => '/',
        'permission_denied' => 'beranda',
        'group_denied'      => 'beranda',
    ];
     ...
     * DISABLED: We handle registration via custom AuthController.
     */
     ...
     * ENABLED: Shield filters are now active (Phase 8).
     */
     ...
     * has been set up.
     * DISABLED: We use custom OTP flow, not magic links.
     */
