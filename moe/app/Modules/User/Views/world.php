...
<body class="landing-page">
    ...
    <div class="page-wrapper">
        ...
        <!-- NAVBAR -->
        <?= $this->include('App\Modules\User\Views\partials\public\navbar') ?>
    ...
    <script>
        ...
        const SANCTUARY_DATA = {
            horus: {
                ...
                emblem: ASSET_BASE + 'assets/faction emblem/faction_horus.png',
                ...
                url: '<?= base_url('guild?faction=horus') ?>'
            },
            khonshu: {
                name: 'Sanctuary of Khonshu',
                emblem: ASSET_BASE + 'assets/faction emblem/faction_khonshu.png',
                ...
                url: '<?= base_url('guild?faction=khonshu') ?>'
            },
            osiris: {
                name: 'Sanctuary of Osiris',
                emblem: ASSET_BASE + 'assets/faction emblem/faction_osiris.png',
                ...
                url: '<?= base_url('guild?faction=osiris') ?>'
            },
            hathor: {
                name: 'Sanctuary of Hathor',
                emblem: ASSET_BASE + 'assets/faction emblem/faction_hathor.png',
                ...
                url: '<?= base_url('guild?faction=hathor') ?>'
            },
            ammit: {
                name: 'Sanctuary of Ammit',
                emblem: ASSET_BASE + 'assets/faction emblem/faction_ammit.png',
                ...
                url: '<?= base_url('guild?faction=ammit') ?>'
            },
            pyramid: {
                name: 'Pyramid Khufu & Khafre',
                emblem: ASSET_BASE + 'assets/landing/logo.png',
