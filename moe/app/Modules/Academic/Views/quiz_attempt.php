...
<body>
    <div class="quiz-container">
        <!-- Header -->
        <?= view('App\Modules\Academic\Views\partials\quiz\_header_attempt') ?>

        <!-- Progress -->
        <div class="progress-text"><span id="answeredCount">0</span> of
    ...
    <!-- Result Modal -->
    <?= view('App\Modules\Academic\Views\partials\quiz\_result_modal') ?>

    <!-- Quiz Config (data-attributes for external JS) -->
