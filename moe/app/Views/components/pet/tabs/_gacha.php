...
<section id="gacha" class="tab-panel">
    <div class="gacha-section">
        ...
        <div class="gacha-comparison">
            <!-- Normal Gacha Card -->
            <div class="gacha-card normal-card glass-premium">
                <div class="hieroglyph-overlay"></div>
                ...
                <div class="gacha-card-body">
                    ...
                    <div class="gacha-rates">
                        ...
                        <div class="rate-row">
                            ...
                            <span class="rate-value">1.8%</span>
                        </div>
                        <div class="rate-row highlight">
                            <span class="rate-label mythical">Mythical</span>
                            <span class="rate-value">0.2%</span>
                        </div>
                    </div>
            ...
            <!-- Premium Gacha Card -->
            <div class="gacha-card premium-card glass-premium">
                <div class="hieroglyph-overlay"></div>
                ...
                <div class="gacha-card-body">
                    ...
                    <div class="gacha-rates premium">
                        ...
                        <div class="rate-row">
                            <span class="rate-label legendary">Legendary</span>
                            <span class="rate-value">18%</span>
                        </div>
                        <div class="rate-row highlight">
                            <span class="rate-label mythical">Mythical</span>
                            <span class="rate-value">2.0%</span>
                            <span class="rate-boost">NEW!</span>
                        </div>
                    </div>
        ...
        <!-- Shiny Promotion & Info Section -->
        <div class="gacha-info-section">
            <!-- Shiny Promotion Banner -->
            <?php if ($hasBeastiary): ?>
            ...
            <?php else: ?>
                <div class="shiny-promo locked glass-premium" onclick="location.href='<?= base_url('sanctuary') ?>'">
                    ...
                    <p>Unlock <strong>Beastiary Library</strong> in Sanctuary for <span class="highlight-text">+5% Shiny
                            Chance</span>!</p>
                </div>
            <?php endif; ?>
